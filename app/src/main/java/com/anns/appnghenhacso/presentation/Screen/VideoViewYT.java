...
import com.anns.appnghenhacso.data.remote.APIYouTube.APIServiceSearchYT;
import com.anns.appnghenhacso.data.remote.APIYouTube.DataserviceYT;
import com.anns.appnghenhacso.domain.model.ModelYT.ItemDetailVideoYT;
import com.anns.appnghenhacso.domain.model.ModelYT.ItemYT;
...
//            }
    ...
    public void playClick() {
        ...
        if (cn.getClassName().equals("com.anns.appnghenhacso.presentation.Screen.VideoViewYT")) {
            if (videoview.isPlaying()) {
                videoview.pause();
                NotifyPause();
            } else {
